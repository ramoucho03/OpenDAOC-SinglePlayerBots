...
namespace DOL.GS
{
    ...
    public class Region
    {
        ...
        public virtual bool IsRvR
        {
            get
            {
                // RvR regions: New Frontiers (163, the unified NF map) and the
                // various battleground / RvR dungeon regions. Region 163 is
                // the primary RvR theatre — keeps, relics, mimic frontier
                // groups all live here. The three classic realm regions
                // (1 Albion / 100 Midgard / 200 Hibernia) host PvE leveling
                // content and are NOT region-wide RvR (their RvR zones are
                // tagged at Zone level via Zone.IsRvR).
