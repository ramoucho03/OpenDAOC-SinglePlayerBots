...
namespace DOL.GS
{
    public class NecromancerPet : GameSummonedPet
    {
        ...
        public override int Health
        {
            ...
            set
            {
                ...
                if (oldPercent != HealthPercent)
                {
                    ...
                    IGamePlayer owner = (Brain as IControlledBrain).Owner as IGamePlayer;
                    owner.Group?.UpdateMember((GameLiving)owner, false, false);
                }
            }
        }
        ...
        {
            if ((Brain as IControlledBrain).Owner is not IGamePlayer)
                return;
