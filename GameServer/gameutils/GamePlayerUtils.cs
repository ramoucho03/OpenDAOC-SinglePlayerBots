...
namespace DOL.GS
{
    ...
    public static class GamePlayerUtils
    {
        ...
        public static List<(SpellLine, List<Skill>)> UpdateUsableListSpells(IGamePlayer player, List<(SpellLine, List<Skill>)> usableListSpells)
        {
        ...
        public static List<(Skill, Skill)> UpdateUsableSkills(IGamePlayer player, List<(Skill, Skill)> usableSkills)
        {
