...
{
    /// <summary>
    /// Mauler (Midgard) spec table for mimics. Same spec layout as the Albion
    /// and Hibernia Maulers — the Catacombs class is shared, only the base
    /// class kept separate per realm for race / story reasons.
    /// </summary>
    public class MaulerMidSpec : MimicSpec
    {
        public MaulerMidSpec()
        {
            SpecName = "MaulerMidSpec";
