namespace DOL.GS.Scripts
{
    ...
    ///   - SpectralGuard: PBAoE damage + AoE pressure (the closest thing
    ...
    public class BainsheeSpec : MimicSpec
    {
        public BainsheeSpec(eSpecType spec)
        {
            ...
            switch (randVariance)
            {
                ...
                Add(Specs.SpectralGuard, 12, 0.1f);
                break;
                ...
                // SpectralGuard 44 — AoE pressure with PW backup
                case 2:
                Add(Specs.SpectralGuard, 44, 0.8f);
                ...
                Add(Specs.SpectralGuard, 18, 0.1f);
                break;

                // AoE-CC variant: SpectralGuard maxed for AoE lockdown.
                // Group filler when no dedicated CC class is available —
                // SG shouts interrupt and soften multiple adds in PBAoE
                // range, letting the tank and DPS clean up afterwards.
                case 4:
                Add(Specs.SpectralGuard, 50, 1.0f);
