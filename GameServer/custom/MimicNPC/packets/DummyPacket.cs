...
namespace DOL.GS.Scripts
{
    public class DummyPacketLib : IPacketLib
    {
        ...
        // Added upstream after our fork: the engine now distinguishes
        // hybrid spell lines (per-spec) from baseline lines. Mimics have
        // no client to render the list, so this is a no-op stub.
