...
namespace DOL.GS.PacketHandler
{
    ...
    public enum eLoginError : byte
    {
        ...
        ClosedAccount = 0x0a,                       // Your account has been closed.
        AccountAlreadyLoggedIn = 0x0b,              // Your account is already logged in.
        TooManyPlayersLoggedIn = 0x0c,              // The server is at max population. Please try later.
        ...
        TooManyFreeAccountsLoggedIn = 0x12,         // The server is at max population for free accounts. Please try later.
        AccountNeedsInvite = 0x13,                  // Your account needs an invite for this server.
        BannedAccount = 0x14,                       // Your account has been banned.
        Unknown = 0x15,                             // Unknown error.
        NotAuthorizedToUseExpansionVersion = 0x17,  // You are not authorized to use the expansion version.
        OnlyOneFreeAccountPerPc = 0x18,             // Only one free account per PC is allowed.
        RequestedServerNotFound = 0x19,             // Requested server wasn't found.
        EndlessConquestAccountNotAllowed = 0x1a,    // Endless Conquest accounts are not currently allowed on this server.
        ServiceNotAvailable = 0xaa                  // Service not available.
        // 0x04 Service not available.
        // 0x0e Service not available.
        // 0x0f Service not available.
        // 0x16 Service not available.
        // [0x1b..0x20] Service not available.
    };
