    ...
    public class AttackAction
    {
        ...
        protected virtual bool PrepareMeleeAttack()
        {
            ...
            if (clearOldStyles)
            {
                ...
                if (StyleComponent.NextCombatBackupStyle?.GetProcOfType(eSpellType.NaturesShield) != null)
                    StyleComponent.NextCombatStyle = StyleComponent.NextCombatBackupStyle;
                else if (StyleComponent.NextCombatStyle?.GetProcOfType(eSpellType.NaturesShield) == null)
