...
namespace DOL.GS.Spells
{
	...
	/// </summary>
	/// <author>IST</author>
	[SpellHandler(eSpellType.SummonHunterPet)]
	public class SummonHunterPet : SummonSpellHandler
	{
        ...
        public override bool CheckEndCast(GameLiving selectedTarget)
        {
            ...
            {
                MessageToCaster(LanguageMgr.GetTranslation((Caster as IGamePlayer).Client, "Summon.CheckBeginCast.AlreadyHaveaPet"), eChatType.CT_SpellResisted);
                return false;
            }
