-- loototd: full reimport from DOLSharp (72 rows).
-- Wipe is done in 01_wipe.sql; this file just bulk-inserts.

SET FOREIGN_KEY_CHECKS=0;

INSERT IGNORE INTO `loototd` (`MobName`, `ItemTemplateID`, `MinLevel`, `LastTimeRowUpdated`, `LootOTD_ID`) VALUES
  ...
  ('Howl', 'Howl''s_Remains', 35, '2000-01-01 00:00:00', '1d9f2520-03f0-41c9-890f-afba3ac49429'),
  ('Hrrgyf', 'Hrrgyfs_Remains', 10, '2000-01-01 00:00:00', '23c7744d-d72e-4ba2-ab74-63c9c4f50a4a'),
  ...
  ('Stripe', 'Stripes_Remains', 25, '2000-01-01 00:00:00', '2cf73504-b3e3-417f-a527-134ac69678bb'),
  ('Wilde', 'Wilde''s_Mane', 20, '2000-01-01 00:00:00', '3071fa1d-d73c-44c7-a386-3619c4d12d34'),
  ('Snarls', 'Snarls''_Remains', 7, '2000-01-01 00:00:00', '33621101-4f00-4b34-9184-e1ad0deff491'),
  ...
  ('Zrit-Zrit', 'Zrit-Zrit''s_Remains', 35, '2000-01-01 00:00:00', '4c2370a4-356a-4fe6-9b1f-998e73a71e47'),
  ...
  ('Spat', 'Spats_Remains', 8, '2000-01-01 00:00:00', '5e603492-6b96-448a-a21e-8fbde8d71ba9'),
  ...
  ('Sentry Incin', 'Sentry_Incin''s_Remains', 21, '2000-01-01 00:00:00', '8d787601-d87c-41e4-acc7-b5f8ed70b442'),
  ...
  ('Queen Major', 'Queen_Majors_Remains', 15, '2000-01-01 00:00:00', '9d4d8aa3-497f-4d6c-97b8-ac9c95a27ab3'),
  ...
  ('Prugor', 'Prugor''s_Remains', 12, '2000-01-01 00:00:00', 'c677efd9-044d-4e57-ab97-2d17b4fa2e87'),
